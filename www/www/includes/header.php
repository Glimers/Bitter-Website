...
<!-- didn't use <php because it worked with just html  -->
<html>
    ...
    <body>
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
		...
		<?php
                    ...
                    echo "<img class='bannericons' src='" . $_SESSION["SESS_PROFILE_PIC"] . "'>" ?>
			</a>
        ...
        <form class="form-inline my-2 my-lg-0" method="get" action="search.php" id="searching">
